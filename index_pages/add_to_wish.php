...
if (!empty($productId)) {
    ...
    $query = "SELECT * FROM wishlist WHERE  product_id = ? AND user_id=?";
    ...
    if ($result->num_rows > 0) {
        ...
        $updateQuery = "UPDATE wishlist SET quantity = quantity + ? WHERE product_id = ? AND user_id=?";
        ...
        $insertQuery = "INSERT INTO wishlist ( product_id,user_id, ip_address, quantity) VALUES (?, ?, ?,?)";
