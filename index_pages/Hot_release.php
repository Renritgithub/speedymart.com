...
$select_query = "SELECT * FROM `products` WHERE is_hot_release = ? ORDER BY product_id DESC LIMIT 5";
$stmt = $con->prepare($select_query);
$hot_release_value = 1; // Or 0, depending on your requirement
$stmt->bind_param("i", $hot_release_value); // "i" for integer type
if ($stmt->execute()) {
    // Fetch the result
