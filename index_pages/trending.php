...
$select_query = "SELECT * FROM `products` WHERE is_trending = ? ORDER BY RAND() LIMIT 5";
$stmt = $con->prepare($select_query);
$trend_value = 1; // Or 0, depending on your requirement
$stmt->bind_param("i", $trend_value ); // "i" for integer type
if ($stmt->execute()) {
    // Fetch the result
