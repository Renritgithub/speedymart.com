...
$select_query = "SELECT * FROM `products` WHERE is_deal = ? ORDER BY RAND() LIMIT 5";
$stmt = $con->prepare($select_query);
$deal_value = 1; // Or 0, depending on your requirement
$stmt->bind_param("i", $deal_value); // "i" for integer type
if ($stmt->execute()) {
    // Fetch the result
